-- ============================================================================
-- migration_067_security_rate_limit_consumir.sql
--
-- Fonte versionada do limitador atômico genérico usado por endpoints públicos
-- controlados pelo Worker (telemetria, webhooks/controles futuros).
-- Nunca expor execução a anon/authenticated: o browser fala com o Worker.
-- ============================================================================
...
begin
  ...
  if p_max_tentativas < 1 or p_max_tentativas > 10000
...
revoke all on function public.rate_limit_consumir(text, integer, integer)
  from public, anon, authenticated;

grant execute on function public.rate_limit_consumir(text, integer, integer)
  to service_role;
