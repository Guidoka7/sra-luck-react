-- Delta 068: close concurrent first-use race in 067. No business data/schema changes.
-- Rollback: redeploy the previous runtime; keep this compatible RPC correction.
-- Only service_role may execute. Existing counters and cron remain untouched.
