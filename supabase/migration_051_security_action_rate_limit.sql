-- Rate limit de consumo real para ações (diferente do contador de falhas de login).
-- Reutiliza login_rate_limits apenas como armazenamento técnico de janelas.
...
begin
  ...
  if p_max_tentativas < 1 or p_max_tentativas > 10000 or p_janela_segundos < 1 or p_janela_segundos > 86400 then
    return false;
  end if;
