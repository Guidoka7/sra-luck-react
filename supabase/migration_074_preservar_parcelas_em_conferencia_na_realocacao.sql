-- migration_074_preservar_parcelas_em_conferencia_na_realocacao.sql
--
-- Refinamento da realocação: parcelas em conferência são protegidas como
-- parcelas pagas e não mudam de numeração durante uma suspensão de outra parcela.
