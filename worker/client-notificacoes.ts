 ...
 * `notificacoes_cliente` (migration_010) — antes deste módulo, nenhum
 * handler do Worker respondia por essas rotas, então a Central de
 * Notificações do frontend nunca recebia dado real.
 */
