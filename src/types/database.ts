...
export type StatusContratoCliente = "ativo" | "suspenso" | "negativado" | "cancelado";
...
export const STATUS_CONTRATO_LABEL: Record<StatusContratoCliente, string> = { ativo: "Ativo", suspenso: "Suspenso", negativado: "Negativado", cancelado: "Cancelado" };
