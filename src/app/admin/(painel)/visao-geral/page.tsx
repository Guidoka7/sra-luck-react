  ...
  return <div className="zip-admin">
    ...
    <CardShell>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr) 1.7fr", gap: 7, padding: "8px 10px" }}>
        ...
        <div style={{ border: "1px solid var(--line2)", borderRadius: 9, padding: 8 }}><div style={{ display: "flex", alignItems: "center", gap: 7 }}><span style={zipIconBox("blue", 28)}>▯</span><div><div style={{ fontSize: 9, fontWeight: 700 }}>PWA instalado</div><div className="zip-mono" style={{ fontSize: 13, fontWeight: 800, marginTop: 2 }}>{visao.monitoramento.pwaInstaladoPercentual}%</div></div></div><div style={{ fontSize: 7.8, color: "var(--soft)", marginTop: 5 }}>{visao.monitoramento.pwaInstalados} de {visao.monitoramento.totalDispositivos} clientes</div></div>
        <div style={{ border: "1px solid var(--line2)", borderRadius: 9, padding: 8 }}><div style={{ display: "flex", alignItems: "center", gap: 7 }}><span style={zipIconBox("rose", 28)}>☻</span><div><div style={{ fontSize: 9, fontWeight: 700 }}>Sem acesso recente</div><div className="zip-mono" style={{ fontSize: 13, fontWeight: 800, marginTop: 2 }}>{visao.monitoramento.semAcessoRecente}</div></div></div><div style={{ fontSize: 7.8, color: "var(--soft)", marginTop: 5 }}>há mais de 7 dias</div></div>
