...
const faqs = () => [
  { pergunta: "Como funciona a liberação da minha agenda?", resposta: `Ao atingir o percentual mínimo de parcelas pagas do seu plano, você pode solicitar a liberação financeira no app. Aprovado o levantamento e confirmado o custeio do saldo, você segue para os termos. Depois da assinatura dos termos e da quitação confirmada, é iniciada a liberação da agenda da cirurgia, que ocorre em até ${prazoLiberacaoDiasUteis()} dias úteis.` },
