...
import { LinhaModoEscuro } from "@/components/cliente/tema/ControlesTema";
...
const FAQS = [
  { pergunta: "Como funciona a liberação da minha agenda?", resposta: `Ao atingir o percentual mínimo de parcelas pagas do seu plano, você pode solicitar a liberação financeira no app. Aprovado o levantamento e confirmado o custeio do saldo, você segue para os termos. Depois da assinatura dos termos e da quitação confirmada, é iniciada a liberação da agenda da cirurgia, que ocorre em até ${PRAZO_LIBERACAO_CIRURGICA_DIAS_UTEIS} dias úteis.` },
...
function IconeMenu({ tipo }: { tipo: "documentos" | "jornada" | "atendimento" | "faq" | "configuracoes" | "seguranca" | "sair" }) {
...
export function MaisTab({ nomeCliente, onSair, renderJornada, initialSubTela = null, onInitialSubTelaConsumed }: MaisTabProps) {
