...
import { etapaAgenda, passoDaTrilha, prazoLiberacaoDiasUteis, statusAgenda, termosJaAssinados, TRILHA_AGENDA, type EtapaAgenda } from "@/components/cliente/agenda/agendaEtapa";
  ...
  switch (etapa) {
    ...
    case "termos_assinados":
      cartao = cirurgiaLiberada
        ...
        : <CartaoEtapa tom="ambar" etapa={etapa} rotulo="Agora · Última etapa" titulo="Agenda cirúrgica em liberação" texto={liberarEm ? `A escolha da data da cirurgia será liberada a partir de ${brDate(liberarEm)}.` : `Com os termos assinados e a quitação confirmada, sua agenda cirúrgica é liberada em até ${prazoLiberacaoDiasUteis()} dias úteis.`} />;
      break;
    case "cirurgia": {
