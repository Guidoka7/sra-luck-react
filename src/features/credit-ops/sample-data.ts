...
export const contracts: CreditContract[] = [
  { id: "CTR-2026-0482", client: "Renata Oliveira", cpf: "123.456.789-00", campaign: "RD Station", modality: "Flex", total: 50000, paid: 32500, minimumPercent: 60, installmentsPaid: 14, installmentsTotal: 24, forecastMinimum: "Meta atingida", remaining: 17500, stage: "meta_atingida", bank: "Banco do Brasil" },
  { id: "CTR-2026-0310", client: "Carlos Mendes", cpf: "987.654.321-00", campaign: "Indicação", modality: "100% boleto", total: 35000, paid: 20300, minimumPercent: 60, installmentsPaid: 10, installmentsTotal: 24, forecastMinimum: "28/09/2026", remaining: 14700, stage: "proxima_meta", bank: "Santander" },
  { id: "CTR-2026-0296", client: "Juliana Costa", cpf: "456.789.123-00", campaign: "Instagram", modality: "Flex", total: 80000, paid: 46200, minimumPercent: 60, installmentsPaid: 12, installmentsTotal: 36, forecastMinimum: "05/10/2026", remaining: 33800, stage: "proxima_meta", bank: "BRB" },
  ...
  { id: "CTR-2026-0322", client: "Fernanda Alves", cpf: "789.456.123-00", campaign: "Site / Orgânico", modality: "Flex", total: 25000, paid: 14900, minimumPercent: 60, installmentsPaid: 9, installmentsTotal: 18, forecastMinimum: "21/09/2026", remaining: 10100, stage: "levantamento_financeiro", bank: "Efí" },
