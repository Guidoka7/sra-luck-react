...
export function DrawerIcon({ name, ...props }: SVGProps<SVGSVGElement> & { name: IconName }) {
  ...
  switch (name) {
    ...
    case "flow": return <svg {...common} fill="none" strokeWidth="1.7"><circle cx="5" cy="6" r="2"/><circle cx="5" cy="18" r="2"/><circle cx="19" cy="12" r="2"/><path d="M7 6h4a4 4 0 0 1 4 4v0M7 18h4a4 4 0 0 0 4-4v0M15 12h2"/></svg>;
    case "route": return <svg {...common} fill="none" strokeWidth="1.7"><circle cx="6" cy="19" r="2"/><circle cx="18" cy="5" r="2"/><path d="M8 19h8.5a3.5 3.5 0 0 0 0-7h-9a3.5 3.5 0 0 1 0-7H16"/></svg>;
