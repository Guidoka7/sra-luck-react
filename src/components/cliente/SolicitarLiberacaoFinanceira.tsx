...
interface Props {
  ...
  /** A aba Agenda já mostra data/horário da assinatura, saldo e forma de
   * pagamento no cartão do topo: oculta esses resumos repetidos aqui. */
