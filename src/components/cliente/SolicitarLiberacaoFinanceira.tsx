...
interface Props { ativo?: boolean; termosAssinados?: boolean; onCirurgiaConfirmada?: () => void | Promise<void>; }
...
export function SolicitarLiberacaoFinanceira({ ativo = true, termosAssinados = false, onCirurgiaConfirmada }: Props) {
  ...
  if (termosAssinados) {
    return <CalendarioCirurgia dataAssinatura={dataAssinaturaTermos} onConfirmada={confirmarCirurgia} termosAssinados formaCusteio={solicitacao?.forma_custeio ?? null} />;
  }
  ...
  return <>
    <div className="flex flex-col gap-[11px]">
      ...
      <CalendarioCirurgia dataAssinatura={dataAssinaturaTermos} onConfirmada={confirmarCirurgia} formaCusteio={solicitacao?.forma_custeio ?? null} />
    </div>
