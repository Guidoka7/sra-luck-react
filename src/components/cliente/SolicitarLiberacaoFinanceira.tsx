...
export function SolicitarLiberacaoFinanceira({ ativo = true, termosAssinados = false, onCirurgiaConfirmada }: Props) {
  ...
  if (termosAssinados) {
    return <CalendarioCirurgia dataAssinatura={dataAssinaturaTermos} onConfirmada={confirmarCirurgia} termosAssinados />;
  }
  ...
  return <>
    <div className="flex flex-col gap-[11px]">
      ...
      <CalendarioCirurgia dataAssinatura={dataAssinaturaTermos} onConfirmada={confirmarCirurgia} />
    </div>
