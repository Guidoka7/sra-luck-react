  ...
  return <div className="rounded-2xl border border-rose/15 bg-white/70 p-3.5 shadow-sm dark:border-white/10 dark:bg-white/[0.035] sm:p-4">
    ...
    <AnimatePresence>{aberto && <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }} transition={{ duration: 0.3, ease: [0.22, 1, 0.36, 1] }} className="overflow-hidden">
      <div className="mt-3 space-y-3 border-t border-rose/10 pt-3">
        ...
        <p className="text-[0.8rem] leading-relaxed text-clay/70">Ao atingir o percentual necessário, faremos um levantamento financeiro (em até <strong className="text-burgundy">5 dias úteis</strong>) para confirmar seus pagamentos. Assim que aprovado, você escolhe como deseja pagar o <strong className="text-burgundy">saldo restante</strong> do contrato para, então, liberar a escolha do dia e horário da sua <strong className="text-burgundy">assinatura dos termos cirúrgicos</strong>. No dia da assinatura, você quita o saldo restante em nosso escritório. Depois disso, em até <strong className="text-burgundy">5 dias úteis</strong>, sua agenda libera novamente para você escolher, pelo aplicativo, a <strong className="text-burgundy">data da sua cirurgia</strong>.</p>
      </div>
